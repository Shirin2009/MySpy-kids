...
import com.example.MySpy.ui.openVideoPlugin.SampleVideoActivity
...
class AppManager(private val applicationContext: Context,
    ...
    private val APP_PLUGIN = "com.example.MySpy.plugin.PLUGIN_APPLICATION"
   ...
   * */
    ...
    fun isOpenPlugin(resolveInfos : List<ResolveInfo>) : Boolean {
         return resolveInfos
                .filter{ it.activityInfo.name == "com.example.MySpy.ui.openVideoPlugin.SampleVideoActivity" }
                .isNotEmpty()
    }
